...
namespace VanK
{
    ...
    Renderer::~Renderer()
    {
        std::cout << "Renderer Window" << std::endl;
    ...
    void Renderer::BeginScene()
    {
        ...
        else if (swapchainTexture == nullptr)
        {
    ...
    void Renderer::setColor(float r, float g, float b, float a)
    {
        if (swapchainTexture != nullptr)
        {
            colorTargetInfo = {nullptr};
            colorTargetInfo.texture = swapchainTexture;
            colorTargetInfo.clear_color = SDL_FColor{r, g, b, a};
            colorTargetInfo.load_op = SDL_GPU_LOADOP_CLEAR;
            colorTargetInfo.store_op = SDL_GPU_STOREOP_STORE;
    ...
    void Renderer::Bind() const
    {
        ...
        SDL_GPUBufferBinding buffer_binding1 = {.buffer = VertexBuffer, .offset = 0};
        SDL_BindGPUVertexBuffers(renderPass, 0, &buffer_binding1, 1);
        SDL_GPUBufferBinding buffer_binding3 = {.buffer = IndexBuffer, .offset = 0};
    ...
    void Renderer::Drawss()
    {
        ...
        if (swapchainTexture != nullptr)
        {
            ...
            // Matrix math
            glm::mat4 rotationMatrix2 = glm::rotate(glm::mat4(1.0f), glm::radians(45.0f * t),
            ...
            // Matrix math
            glm::mat4 rotationMatrix4 = glm::rotate(glm::mat4(1.0f), glm::radians(45.0f * t),
                                                    glm::vec3(0.0f, 0.0f, 1.0f));
            ...
            glm::mat4 rotationMatrix3 = glm::rotate(glm::mat4(1.0f), glm::radians(45.0f * t),
                                                    glm::vec3(0.0f, 0.0f, 1.0f));
    ...
    void Renderer::drawQuad() // blank quad
    {
    }
}
